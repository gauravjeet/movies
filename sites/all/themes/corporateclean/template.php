...
function corporateclean_preprocess_page(&$variables) {
  ...
  // Add js for background and text color on grid.
  if (arg(0) == 'filter-by-year') {
	drupal_add_js(drupal_get_path('module', 'add_colorbox_class') . '/add_colorbox_class_colors.js');
  }
}
